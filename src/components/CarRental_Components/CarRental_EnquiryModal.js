...
// ==========================================================
// INPUT STYLE
// Same base styling as About Us form
// ==========================================================
...
export default function CarRental_EnquiryModal({isOpen,onClose,selectedCar = "",}) {
  ...
  // AUTO SELECT VEHICLE
  //
  // If selectedCar comes from the vehicle card,
