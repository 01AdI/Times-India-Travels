...
function TourCard({ pkg, index, className = "" }) {
  ...
  const featuredPackage =
    pkg.packages?.find((tour) => tour.featured) || pkg.packages?.[0];

  const duration = featuredPackage?.duration?.label || "Explore Tours";
  ...
  return (
    ...
    >
      ...
      {/* Decorative badges — these are genuinely visual-only, safe to hide */}
      <div className="absolute left-6 top-6 z-10 sm:left-7 sm:top-7" aria-hidden="true">
      ...
      <div className="absolute right-6 top-6 z-10 sm:right-7 sm:top-7" aria-hidden="true">
      ...
      {/* CONTENT — no longer aria-hidden. This is real, meaningful
          content (name, description, "Explore Journey" affordance),
          not decoration, so it needs to stay in the accessible tree. */}
  ...
  return (
    <MotionConfig reducedMotion="user">
      <section className="relative overflow-hidden bg-[#F2FAFB] py-20 sm:py-24 md:py-28">
        <div className="pointer-events-none absolute -left-40 top-20 h-[500px] w-[500px] rounded-full bg-[#F58634]/[0.025] blur-3xl" />
        <div className="pointer-events-none absolute -right-40 bottom-20 h-[500px] w-[500px] rounded-full bg-[#0B3C49]/[0.025] blur-3xl" />
        ...
        <div className="relative mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-12">
          ...
          >
            ...
            <div className="mx-auto mt-7 h-[2px] w-10 bg-[#F58634]" />
          ...
          {/* Added md:grid-flow-dense — lets the browser backfill gaps
              that mixed col-span/row-span cards can otherwise leave. */}
          ...
          <motion.div
            ...
            className="group rounded-4xl relative mt-5 min-h-[330px] overflow-hidden bg-[#0B3C49] sm:min-h-[360px] md:min-h-[390px]"
          >
            ...
            <div className="relative flex min-h-[330px] flex-col justify-between p-7 sm:min-h-[360px] sm:p-10 md:min-h-[390px] md:p-14 lg:p-16">
              <div className="flex items-center justify-between">
                ...
                <Sparkles className="h-5 w-5 text-[#F58634]" aria-hidden="true" />
              </div>
              ...
              <div className="mt-12 max-w-4xl">
                <h3 className="font-['Fraunces'] text-4xl font-medium leading-[1.05] tracking-[-0.025em] text-white sm:text-5xl md:text-6xl lg:text-7xl">
                  Your India.
                  <span className="block italic text-[#F58634]">Your way.</span>
                </h3>
