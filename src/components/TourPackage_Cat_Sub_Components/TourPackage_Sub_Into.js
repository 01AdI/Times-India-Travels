...
export default function TourPackage_Sub_Intro({ tour, sectionNumber = "01" }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#F2FAFB] py-24 sm:py-28 md:py-36 lg:py-40">
      <div className="pointer-events-none absolute -right-40 top-20 h-[500px] w-[500px] rounded-full bg-[#F58634]/[0.045] blur-3xl" />
      <div className="pointer-events-none absolute -left-48 bottom-0 h-[500px] w-[500px] rounded-full bg-[#124D56]/[0.035] blur-3xl" />
      ...
      <div className="absolute left-0 right-0 top-0 h-px bg-[#124D56]/10" />
      ...
      <div className="relative mx-auto max-w-[1450px] px-6 sm:px-10 lg:px-16 xl:px-20">
        <div className="mb-20 flex items-start justify-between sm:mb-24">
          ...
          >
            <p className="font-['Inter'] text-[10px] font-semibold uppercase tracking-[0.3em] text-[#124D56]/45">
              Curated India
            </p>
        ...
        <div className="grid gap-16 lg:grid-cols-[1.15fr_0.85fr] lg:gap-24 xl:gap-32">
          ...
          >
            ...
            <h2 className="max-w-5xl font-['Fraunces'] text-[1.2rem] font-medium leading-[0.93] tracking-[0.055em] text-[#0B3C49] sm:text-6xl md:text-5xl lg:text-[3.8rem] xl:text-[4.5rem]">
              A journey through
              <span className="block italic text-[#F58634] text-[4.2rem]">
            ...
            <motion.div
              ...
              className="mt-10 h-[2px] bg-[#F58634]"
            />
